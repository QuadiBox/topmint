    ...
    return (
        <div className='solarsystemHomePage' onClick={(e) => {handleToggles( e, setShowOtherPageLinks)}}>
            ...
            <div className='storyExplorationCntn'>
                <iframe src={"https://eyes.nasa.gov/curiosity/?embed=true&amp;logo=false"} allowFullScreen allow='fullscreen' frameborder="0" scrolling='no' width="1200" height="900"></iframe>
            </div>
